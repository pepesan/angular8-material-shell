...
@Component({
  selector: 'app-flex-layout-basic',
  templateUrl: './flex-layout-basic.component.html',
  styleUrls: ['./flex-layout-basic.component.css']
})
export class FlexLayoutBasicComponent implements OnInit {
  pictures = [
    {
      id: 1,
